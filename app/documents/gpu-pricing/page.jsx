    ...
    >
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-gray-300 max-w-3xl mx-auto">
          SAIDI offers a transparent, pay-as-you-go pricing model for all services. 
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="text-[#e35275] border-b border-gray-700">
                <th className="pb-4 text-lg font-semibold">Type</th>
                <th className="pb-4 text-lg font-semibold">Product feature</th>
            ...
            <tbody className="text-gray-300">
              <tr className="border-t border-gray-800">
                <td className="py-4 text-lg">XXX</td>
                <td className="py-4 text-lg">XXX</td>
                <td className="py-4 text-lg">XXX</td>
                <td className="py-4 text-lg">XXX</td>
              </tr>
      ...
      <div className="md:hidden space-y-6">
        <div className="bg-gray-900/50 rounded-2xl p-6 backdrop-blur-sm">
          <h3 className="text-xl font-semibold text-[#e35275] mb-4">XXX</h3>
          <div className="grid grid-cols-2 gap-4 text-base">
            <div className="text-gray-400">Product feature</div>
            <div className="font-medium">XXX</div>
      ...
      <section className="mt-20 bg-gray-900/50 rounded-2xl p-8 backdrop-blur-sm">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-300">
          <li className="flex items-center space-x-3">
            ...
            <span>Full root access to products instances</span>
          </li>
          <li className="flex items-center space-x-3">
            <svg className="w-5 h-5 text-[#4487c5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
            </svg>
            <span>Pre-installed frameworks</span>
          </li>
          <li className="flex items-center space-x-3">
            <svg className="w-5 h-5 text-[#4487c5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
