  ...
  return (
    ...
    >
      ...
      <p className="text-gray-300">
        SAIDI Cloud is powered by OpenStack 鈥� a modular, open-source cloud platform that gives us the flexibility and control to deploy GPU resources at scale, securely and efficiently. Below are key OpenStack services that power our platform:
      </p>
      ...
      <section className="space-y-6">
        ...
        <p className="text-gray-300">
          Ironic provides bare metal provisioning 鈥� giving customers direct access to physical GPU servers with no hypervisor layer, for maximum performance.
        </p>
        <Link
        ...
        <p className="text-gray-300">
          Nova is the core compute engine of OpenStack, responsible for provisioning and managing virtual machines 鈥� including GPU-enabled flavors on SAIDI Cloud.
        </p>
        <Link
