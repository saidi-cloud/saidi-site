    ...
    >
        ...
        <div className="grid gap-6">
          <div className="bg-gray-900/50 rounded-xl p-6 backdrop-blur-sm">
            ...
            <ul className="text-gray-400 space-y-2">
              <li>鈥� Repository: github.com/saidi-cloud</li>
              <li>鈥� Access: Requires GitHub account and team membership</li>
              <li>鈥� Purpose: Code management and collaboration</li>
            </ul>
          </div>
          ...
          <div className="bg-gray-900/50 rounded-xl p-6 backdrop-blur-sm">
            ...
            <ul className="text-gray-400 space-y-2">
              <li>鈥� URL: app.netlify.com/teams/saidi-cloud/projects</li>
              <li>鈥� Access: Requires Netlify team membership</li>
              <li>鈥� Purpose: Website deployment and hosting</li>
            </ul>
          </div>
          ...
          <div className="bg-gray-900/50 rounded-xl p-6 backdrop-blur-sm">
            ...
            <ul className="text-gray-400 space-y-2">
              <li>鈥� Registrar: Exabytes.sg</li>
              <li>鈥� Domain: saidi.sg</li>
              <li>鈥� Renewal: June 7, 2026</li>
              <li>鈥� Nameservers: Configured for Netlify</li>
            </ul>
          </div>
          ...
          <div className="bg-gray-900/50 rounded-xl p-6 backdrop-blur-sm">
            ...
            <ul className="text-gray-400 space-y-2">
              <li>鈥� Provider: Zoho Mail</li>
              <li>鈥� Domain: saidi.sg</li>
              <li>鈥� Purpose: Business communications</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className="bg-gray-900/50 rounded-xl p-6 backdrop-blur-sm">
          <ul className="text-gray-300 space-y-4">
            <li className="flex items-start space-x-3">
              <span className="text-[#4487c5]">鈥�</span>
      ...
      <section className="space-y-6">
        ...
        <div className="bg-gray-900/50 rounded-xl p-6 backdrop-blur-sm">
          ...
          <ul className="text-gray-400 space-y-2">
            <li>鈥� Technical Support: Innovaas Solutions</li>
            <li>鈥� Email: support@innovaas.co</li>
            <li>鈥� Phone: +65 3106 5073</li>
          </ul>
        </div>
      </section>
